...
git clone https://github.com/OnePlus-Nord4-devs/android_kernel_oneplus_sm7675-modules.git kernel/module/sm8650-common
# Sync 
...
source build/envsetup.sh
lunch lineage_avalon-ap2a-userdebug && mka bacon
