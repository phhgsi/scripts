...
git clone https://github.com/phhgsi/device_oneplus_sm6375-common.git -b fourteen device/oneplus/sm6375-common
...
rm -rf prebuilts/clang/host/linux-x86/r450784d
git clone https://gitlab.com/ImSurajxD/clang-r450784d.git prebuilts/clang/host/linux-x86/r450784d
export PATH="$HOME/tmp/src/android/prebuilts/clang/host/linux-x86/r450784d/bin:$PATH"
