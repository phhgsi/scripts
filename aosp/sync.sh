...
git clone https://github.com/derpfestoscar/device_oneplus_oscar.git -b aosp device/oneplus/oscar
rm -rf device/oneplus/sm6375-common
git clone https://github.com/phhgsi/device_oneplus_sm6375-common.git -b aosp device/oneplus/sm6375-common
